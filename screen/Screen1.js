    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.containers2}>
        <Avatar.Image
          size={50}
          source={{
            uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_-igLXcILLWHwUXTnnRJ7kO9cOSZ9olaytg&usqp=CAU",
          }}
        />
        <View style={styles.containers1}>
          <Text style={styles.buttonText1}>Rowena Suizo</Text>
          <Text style={styles.buttonTexts}>My Progress</Text>
          <ProgressBar progress={0.7} color="#674fa3" />
